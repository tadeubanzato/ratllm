...
Okame distinguishes documented, observed, estimated, manual, and unknown limits. Manual values have unconditional precedence. Estimated safe limits are floored after applying a configurable safety factor (default 70%).
