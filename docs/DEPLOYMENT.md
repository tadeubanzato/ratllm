...
Compose starts `curator-web` and persistent PostgreSQL 17. LiteLLM and n8n remain external. The Node Alpine image supports standard AMD64/ARM64 Docker hosts.
