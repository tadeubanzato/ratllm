...
export const sourceRegistry: readonly SourceConfig[] = [
  ...
  {id: "groq", tier: "A2", name: "Groq Free Plan Limits", adapter: "text_candidates", url: "https://console.groq.com/docs/rate-limits", registrationUrl: "https://console.groq.com/keys", focusTerms: ["Free Plan Limits", "MODEL ID", "RPM", "RPD", "TPM", "TPD"], providerHint: "Groq", description: "Authoritative list of free-plan models and their exact rate limits."},
  {id: "nvidia_nim", tier: "A2", name: "NVIDIA NIM Model Catalog", adapter: "text_candidates", url: "https://build.nvidia.com/models", registrationUrl: "https://build.nvidia.com/", focusTerms: ["Free Endpoint", "Downloadable Free Endpoint"], providerHint: "NVIDIA NIM", description: "Hosted NIM free endpoints and new open models."},
  {id: "alibaba", tier: "A2", name: "Alibaba Model Studio Free Quota", adapter: "text_candidates", url: "https://www.alibabacloud.com/help/en/model-studio/new-free-quota", registrationUrl: "https://modelstudio.console.alibabacloud.com/", focusTerms: ["free quota", "Qwen", "Model"], providerHint: "Alibaba Model Studio", description: "Authoritative Qwen/Tongyi free-quota eligibility."},
  {id: "zai", tier: "A2", name: "Z.AI / Zhipu Pricing", adapter: "text_candidates", url: "https://docs.z.ai/guides/overview/pricing", registrationUrl: "https://z.ai/", focusTerms: ["Free", "GLM"], providerHint: "Zhipu", description: "Authoritative GLM model pricing and free-status source."},
  {id: "kilo", tier: "A2", name: "Kilo Free Models", adapter: "text_candidates", url: "https://kilo.ai/landing/free-models", registrationUrl: "https://kilo.ai/", focusTerms: ["free", "$0", "model"], providerHint: "Kilo", description: "Live hosted models with zero token pricing."},
