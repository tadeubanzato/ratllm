...
const endpoints:Readonly<Record<string,{url:string;auth:"bearer"|"query"}>>={
  groq:{url:"https://api.groq.com/openai/v1/models",auth:"bearer"},cerebras:{url:"https://api.cerebras.ai/v1/models",auth:"bearer"},nvidia:{url:"https://integrate.api.nvidia.com/v1/models",auth:"bearer"},"google-ai-studio":{url:"https://generativelanguage.googleapis.com/v1beta/models",auth:"query"},openrouter:{url:"https://openrouter.ai/api/v1/auth/key",auth:"bearer"},mistral:{url:"https://api.mistral.ai/v1/models",auth:"bearer"},sambanova:{url:"https://api.sambanova.ai/v1/models",auth:"bearer"},cohere:{url:"https://api.cohere.com/v1/models",auth:"bearer"},"hugging-face":{url:"https://huggingface.co/api/whoami-v2",auth:"bearer"},"opencode-zen":{url:"https://opencode.ai/zen/v1/models",auth:"bearer"},llm7:{url:"https://api.llm7.io/v1/models",auth:"bearer"},"alibaba-model-studio":{url:"https://dashscope.aliyuncs.com/compatible-mode/v1/models",auth:"bearer"},zhipu:{url:"https://open.bigmodel.cn/api/paas/v4/models",auth:"bearer"},deepseek:{url:"https://api.deepseek.com/models",auth:"bearer"},minimax:{url:"https://api.minimax.io/v1/models",auth:"bearer"},
  pollinations:{url:"https://gen.pollinations.ai/v1/models",auth:"bearer"},"public-ai":{url:"https://api.publicai.co/v1/models",auth:"bearer"},
  "cloudflare-workers-ai":{url:"https://api.cloudflare.com/client/v4/user/tokens/verify",auth:"bearer"},
  // ollama-cloud, vercel-ai-gateway and kilo's /v1/models endpoints are confirmed public/unauthenticated per their own docs — they return 200 for any or no key, so they can't actually discriminate a valid credential and are deliberately left out here rather than report a false "verified".
};
