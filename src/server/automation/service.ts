...
const defaults: Record<AutomationType,string>={MODEL_DISCOVERY:"0 */6 * * *",CANDIDATE_VERIFICATION:"15 */6 * * *",HEALTH_MONITOR:"*/10 * * * *",RATE_LIMIT_LEARNING:"30 */6 * * *",PROVIDER_VERIFICATION:"45 */6 * * *",APPLY_APPROVED_PLANS:"0 * * * *",DEEP_BENCHMARK:"0 3 * * *",LANE_RECONCILE:"*/15 * * * *",MAINTENANCE:"30 3 * * *"};
