...
import type { LaneOverviewItem } from "./connection-form";
...
export default async function SettingsPage() {
  ...
  const laneOverview: LaneOverviewItem[] = LANE_IDS.map(slug => ({slug, purpose: LANE_PURPOSES[slug], fallback: LANE_FALLBACKS.general[slug] ?? []}));
