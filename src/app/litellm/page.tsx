...
import { ownerLabel, summarizeOwners, unmanagedNotServing } from "@/server/litellm/ownership";
...
export default async function LiteLLMPage(){
  ...
  const owners=summarizeOwners(rows);const stuck=unmanagedNotServing(rows);
