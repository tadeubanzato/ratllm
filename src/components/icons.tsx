import { Activity, AlertTriangle, BarChart3, Boxes, Braces, Cable, ChartNoAxesCombined, ChevronsUpDown, CircleGauge, Database, FileClock, Gauge, Info, Layers3, Network, PanelLeft, PlayCircle, Search, ServerCog, Settings } from "lucide-react";
